...
class LCD(object):
    ...
    def print1(self, message, style,LCD_LINE_1):
        
        LCD_LINE_1_int = 0x80
        LCD_LINE_1  = LCD_LINE_1_int+LCD_LINE_1
        self.lcd_byte(LCD_LINE_1, self.LCD_CMD)
        self.lcd_string(message, style)

    def print2(self, message, style ,LCD_LINE_2):
        
        LCD_LINE_2_int = 0xC0 
        LCD_LINE_2  = LCD_LINE_2_int+LCD_LINE_2
        self.lcd_byte(LCD_LINE_2, self.LCD_CMD)
        self.lcd_string(message, style)
